...
function RoomFilter({rooms}) {
    const {handleChange,tipo,capacidad,precio,precioMin,precioMax,tamanioMin,tamanioMax,desayuno,mascotas}= useContext(RoomContext);
    //Obtener tipos de piezas unicos
        ...
        <section className="filter-container">
            ...
            <form className="filter-form">
                ...
                <div className="form-group">
                    ...
                    <select name="tipo" id="tipo" value={tipo} className="form-control" onChange={handleChange}>{tipos}</select>
                </div>
                {/* end select tipo*/}
                {/*select capacidad*/}
                <div className="form-group">
                    <label htmlFor="capacity">Capacidad</label>
                    <select name="capacidad" id="capacidad" value={capacidad} className="form-control" onChange={handleChange}>{personas}</select>
                </div>
                {/*end select capacidad */}
                {/* room by precio */}
                <div className="form-group">
                    <label htmlFor="precio">Precio por ${precio}</label>
                ...
                <div className="form-group">
                    ...
                    <div className="single-extra">
                        <input type="checkbox" name="mascotas" id="mascotas" checked={mascotas} onChange={handleChange}></input>
