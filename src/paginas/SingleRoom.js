...
export default class SingleRoom extends Component {
    constructor(props){
        super(props);
        this.state={
            slug: this.props.match.params.id, ImagenxDefecto
        }
    }
                ...
                <section className='single-room'>
                    ...
                    <div className='single-room-info'>
                        ...
                        <article className='info'>
                            ...
                            <h6>Capacidad Máxima: {room.capacity > 1? `${room.capacity} personas`:`${room.capacity} persona`}</h6>
                            <h6>Mascotas:
                                {room.pets? 'se permite mascota' : 'no se permite mascota'}
                            </h6>
                            <h6>
